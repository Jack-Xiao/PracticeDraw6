        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                switch (translationState) {
                    case 0:
                        imageView.animate().translationX(Utils.dpToPixel(100)); //左移 100dp
                        break;
                    case 1:
                        imageView.animate().translationX(0);//返回左移的部分
                        break;
                    case 2:
                        imageView.animate().translationY(Utils.dpToPixel(50)); //向下移动50dp
                        break;
                    case 3:
